...
public class ProcessJDialog extends SubController {

    public ProcessJDialog(java.awt.Frame parent, boolean modal) {
        initComponents();
        runController(() -> {
...
//            java.util.logging.Logger.getLogger(ProcessJDialog.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
...
//            public void run() {
//                ProcessJDialog dialog = new ProcessJDialog(new javax.swing.JFrame(), true);
